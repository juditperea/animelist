        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="card">
                <h3 class="text-lg font-semibold mb-2 bg-red-600 px-4 py-2 rounded-t-lg">Por Ver</h3> 
                    <?php $__currentLoopData = $listas->where('estado', 'por_ver'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($lista->serie->titulo); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="card">
                <h3 class="text-lg font-semibold mb-2 bg-red-600 px-4 py-2 rounded-t-lg">Viendo</h3> 
                    <?php $__currentLoopData = $listas->where('estado', 'viendo'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($lista->serie->titulo); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="card">
                <h3 class="text-lg font-semibold mb-2 bg-red-600 px-4 py-2 rounded-t-lg">Visto</h3> 
                    <?php $__currentLoopData = $listas->where('estado', 'visto'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($lista->serie->titulo); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
...
<?php /**PATH C:\1DAW\M04 LLENGUATGE DE MARQUES\XAMPP2\php\animelist\resources\views/listasSerie.blade.php ENDPATH**/ ?>