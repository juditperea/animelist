        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-2">
                    ...
                    <li><a href="<?php echo e(route('paginasanime')); ?>" class="btn hover:text-gray-400">Páginas</a>
</li>
                </ul>
            </nav>
        </div>
...
<?php /**PATH C:\1DAW\M04 LLENGUATGE DE MARQUES\XAMPP2\php\animelist\resources\views/inicio.blade.php ENDPATH**/ ?>